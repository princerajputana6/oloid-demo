                ...
                <div className='w-1/2'>
                    <div className='p-[10px] py-[59px]'>
                        ...
                        <div className='flex flex-wrap mt-[2.5rem]'>
                            <button className='mr-[1.51rem] flex flex-wrap items-center text-white px-[30px] pt-[20px] pb-[22px] bg-[#2265b0] rounded-[6rem] text-[18px]  font-black'>Get Started &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14" fill="none">
                            ...
                            <button className='flex flex-wrap items-center text-[#2265b0] px-[30px] pt-[20px] pb-[22px] text-[18px]  font-black'>
