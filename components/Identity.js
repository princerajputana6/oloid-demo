    ...
    return (
        <div className='identity-section w-screen flex flex-wrap justify-center'>
            <div className="mx-auto flex flex-wrap flex-col justify-center my-24 max-w-7xl gap-x-9">
                ...
                <div className='identity-cards flex flex-wrap gap-[1.75rem] gap-y-[3.5rem] mt-[3rem] justify-center'>
                    <IdentityCard
                    ...
                    />
                    <IdentityCard
                    image = "https://cdn-gkbkl.nitrocdn.com/EahsqmkNZSarsOQvgGaWKiasFdUDbxev/assets/images/optimized/rev-4a9b36e/www.oloid.ai/wp-content/uploads/2022/06/real-estate-action-building-shield-1.svg"
                    title = "What we do"
                    ...
                    />
                    <IdentityCard
                    image = "https://cdn-gkbkl.nitrocdn.com/EahsqmkNZSarsOQvgGaWKiasFdUDbxev/assets/images/optimized/rev-4a9b36e/www.oloid.ai/wp-content/uploads/2022/06/pet-tracking-tablet-1.svg"
                    title = "How we do it"
